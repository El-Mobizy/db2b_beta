    ...
    public function up(): void
    {
        ...
        DB::table('category_attributes')->insert([
            [
                ...
                'possible_value' => '',
                'isrequired' => true,
                'description' => 'Give the material this product is made of',
                'order_no' => 6,
            ...
            [
                ...
                'isrequired' => true,
                'description' => 'Choose the product size',
                'order_no' => 2,
                'is_price_field' => false,
                'is_crypto_price_field' => false,
                'search_criteria' => true,
            ...
            [
                ...
                'possible_value' => null,
                'isrequired' => false,
                'description' => 'Give the weight of the product in grams',
                'order_no' => 3,
                'is_price_field' => false,
                'is_crypto_price_field' => false,
                'search_criteria' => true,
            ...
            [
                ...
                'isrequired' => false,
                'description' => 'Choose the target audience for the product',
                'order_no' => 4,
                'is_price_field' => false,
                'is_crypto_price_field' => false,
                'search_criteria' => false,
